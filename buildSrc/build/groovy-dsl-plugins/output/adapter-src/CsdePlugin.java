...
/**
 * Precompiled csde script plugin.
 **/
public class CsdePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Csde").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("groovy");
            target.getPluginManager().apply("java");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Csde").asSubclass(BasicScript.class);
